...
/**
 * Get purchase order reconciliation
 *
 * Returns ordered, requested, invoiced, sent, actualized, remaining, and variance amounts with matching details and related record ids.
 */
export const purchaseOrdersReconciliation = <ThrowOnError extends boolean = false>(options: Options<PurchaseOrdersReconciliationData, ThrowOnError>) => (options.client ?? client).get<PurchaseOrdersReconciliationResponses, PurchaseOrdersReconciliationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
