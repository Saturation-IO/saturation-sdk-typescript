...
export const WRITE_OPS = {
  ...
  transactionsUpdate: {
    ...
    bodyType: "{ projectId?: Id | null; contactId?: Id | null; budgetLineId?: Id | null; fringeId?: Id | null; notes?: string | null; number?: string | null; ref?: string | null; amount?: { amount: number (MINOR units - integer count of the smallest currency unit, e.g. cents: $4,750.00 USD = 475000, never major-unit dollars); currency: string (ISO-4217) }; currency?: string; timestamp?: string; type?: 'bank.deposit' | 'bank.withdrawal' | 'bank.ach' | 'bank.wire' | 'card.spend' | 'card.payment' | 'card.refund' | 'card.dispute' | 'card.cashback' | 'Invoice' | 'Projection' | 'Cash' | 'Check' | 'Wire' | 'ACH' | 'CreditCard' | 'TimeCard' | 'ETransfer'; status?: 'unpaid' | 'pending' | 'posted' | 'void' | 'needs_review' | 'projected' | 'rejected'; description?: string | null; merchant?: string | null; sourceLast4?: string | null; sourceName?: string | null; actualized?: boolean; }",
    bodyRequired: true,
